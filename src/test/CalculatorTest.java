...
public class CalculatorTest {
    ...
    public void foCalculate() {
        ...
        if(ans.getNumType().getCode() == NumType.FRACTION.getCode()) {
            ...
            System.out.println(fAns.getHeadNum() + "'" + fAns.getNumer() + "/" + fAns.getDenomin());
        } else {
    ...
    public void ffCalculate() {
        ...
        fraction1.setNumer(5);
        fraction1.setDenomin(7);

        Fraction fraction2 = new Fraction();
        fraction2.setHeadNum(10);
        fraction2.setNumer(4);
        fraction2.setDenomin(8);
